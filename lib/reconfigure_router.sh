...
expect "=>"
send ":dns server forward dnsset add set=100 dns=172.17.5.9 metric=1 label=toVideoNet intf=Video-Voz\r"
expect "=>"
send ":dns server forward dnsset add set=100 dns=172.17.5.10 metric=1 label=toVideoNet intf=Video-Voz\r"
expect "=>"
send ":dns server forward dnsset add set=200 dns=208.122.23.23 metric=0 intf=Internet\r"
expect "=>"
send ":dns server forward dnsset add set=200 dns=208.122.23.22 metric=0 intf=Internet\r"
expect "=>"
send ":saveall\r"
expect "=>"
send ":exit\r"
